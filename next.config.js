...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		// STRING
		NEXT_PUBLIC_ARRANGER_STRING_API: process.env.NEXT_PUBLIC_ARRANGER_STRING_API,
		NEXT_PUBLIC_ARRANGER_STRING_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_STRING_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_STRING_INDEX: process.env.NEXT_PUBLIC_ARRANGER_STRING_INDEX,
		NEXT_PUBLIC_ARRANGER_STRING_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_STRING_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_STRING_STRING_COLUMNS: process.env.NEXT_PUBLIC_ARRANGER_STRING_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_STRING_MAX_BUCKET_COUNTS: process.env.NEXT_PUBLIC_ARRANGER_STRING_MAX_BUCKET_COUNTS || 1000,
		...
		NEXT_PUBLIC_ENABLE_STRING_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_STRING_QUICKSEARCH,
